                ...
                <div class="login-form">
                    ...
                    <form class="form" id="kt_login_singin_form" action="">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control form-control-solid h-auto py-7 px-6 rounded-lg border-0" type="email" name="username" autocomplete="off" />
                        </div>
                        <!--end::Form group-->
                        <!--begin::Form group-->
                        <div class="form-group">
                        ...
                        <div class="login-logo-two">
                            <img src="public/media/cm-top-icon/login-logo-two.png" alt="" />
                        </div>
                        <!--end::Action-->
                    </form>
                    <!--end::Form-->
            ...
            <div class="login-conteiner d-flex align-items-center">
                ...
                <div class="ml-auto mr-auto">
                    <div class="login-thum text-center">
                        <img src="public/media/cm-top-icon/login-logo.png" alt="" />
                    </div>
